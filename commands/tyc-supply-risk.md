...
description: 供应商 18 类风险扫描
argument-hint: "<企业名称或统一社会信用代码>"
---

# /tyc-supply-risk · 供应商 18 类风险扫描

本命令由 SKILL 文件定义，详见：[`../skills/supply-risk/SKILL.md`](../skills/supply-risk/SKILL.md)

## 快速使用

```
/tyc-supply-risk <searchKey>
```
