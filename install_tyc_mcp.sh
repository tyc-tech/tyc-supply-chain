#!/bin/bash
# tyc-supply-chain Installation Script · 一键安装 / Installation
#
# 用法 / Usage:
#   curl 模式（推荐） / curl mode (recommended):
#     bash <(curl -sL https://raw.githubusercontent.com/tyc-tech/tyc-supply-chain/main/install_tyc_mcp.sh)
#
#   本地模式 / local mode:
...
echo "  天眼查 OpenAPI MCP · 供应链 / 采购 6 SKILL"
echo "=========================================="
echo ""
